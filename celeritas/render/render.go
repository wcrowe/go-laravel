...
// Jet template render
func (c *Render) JetPage(w http.ResponseWriter, r *http.Request, tempateName string, variables, data interface{}) error {
	var vars jet.VarMap
	if variables == nil {
	...
	t, err := c.JetViews.GetTemplate(fmt.Sprintf("%s.jet", tempateName))
	if err != nil {
		return err
	}
